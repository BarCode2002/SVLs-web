...
const PreviewSVLs = ({ myAddress, filterSVL }: PreviewSVLsProps): JSX.Element => {
  ...
  const getSVLPreview = () => {
    ...
    updatedPreviewSVLsInfo[4].mainPhotograph = 'https://images.ecestaticos.com/DWa-4iwKF7cA3vKBT9FZdBnFrbA=/463x145:1976x1279/1200x900/filters:fill(white):format(jpg)/f.elconfidencial.com%2Foriginal%2F7cf%2Fc50%2F732%2F7cfc507320c889c4c0560d8c269f5895.jpg';
    ...
    updatedPreviewSVLsInfo[4].stateNotMySVL = [false, 'tz432421d1s24324211aas', '', false]; 

    updatedPreviewSVLsInfo[5].mySVL = false;
    updatedPreviewSVLsInfo[5].mainPhotograph = 'https://cdn.autobild.es/sites/navi.axelspringer.es/public/media/image/2017/07/porsche-911-turbo-s-exclusive-series_6.jpg?tf=3840x';
    ...
    updatedPreviewSVLsInfo[5].stateNotMySVL = [true, 'tz432421d1s24324211aas', 'tz1iRXmfLXK5wWVok4MATJiw3UsgKkH9vrwX', false]; 

    updatedPreviewSVLsInfo[6].mySVL = false;
    updatedPreviewSVLsInfo[6].mainPhotograph = 'https://fotos.quecochemecompro.com/porsche-911/interior-instrumentos-porsche-911.jpg?size=750x400';
    ...
    updatedPreviewSVLsInfo[6].stateNotMySVL = [true, 'tz432421d1s24324211aas', 'tz132123123lññlñ', false]; 

    updatedPreviewSVLsInfo[7].mySVL = false;
    updatedPreviewSVLsInfo[7].mainPhotograph = 'https://newsroom.porsche.com/.imaging/mte/porsche-templating-theme/image_1080x624/dam/pnr/2022/Motorsports/911-GT3-R-world-premiere/M22_3550_fine.jpeg/jcr:content/M22_3550_fine.jpeg';
    updatedPreviewSVLsInfo[7].brand = 'Porsche';
    updatedPreviewSVLsInfo[7].model = '911';
    updatedPreviewSVLsInfo[7].year = '2002';
    updatedPreviewSVLsInfo[7].stateMySVL = [false, '', false]; 
    updatedPreviewSVLsInfo[7].stateNotMySVL = [true, 'tz432421d1s24324211aas', 'tz132123123lññlñ', true]; 

    updatedPreviewSVLsInfo[8].mySVL = false;
    updatedPreviewSVLsInfo[8].mainPhotograph = 'https://res.cloudinary.com/unix-center/image/upload/c_limit,dpr_3.0,f_auto,fl_progressive,g_center,h_240,q_auto:good,w_385/kpjpk6syexcbruz7gasd.jpg';
    updatedPreviewSVLsInfo[8].brand = 'Porsche';
    updatedPreviewSVLsInfo[8].model = '911';
    updatedPreviewSVLsInfo[8].year = '2002';
    updatedPreviewSVLsInfo[8].stateMySVL = [false, '', false]; 
    updatedPreviewSVLsInfo[8].stateNotMySVL = [true, 'tz432421d1s24324211aas', 'tz1iRXmfLXK5wWVok4MATJiw3UsgKkH9vrwX', true]; 

    for (let i = 9; i < 20; i++) {
      updatedPreviewSVLsInfo[i].mySVL = true;
      updatedPreviewSVLsInfo[i].mainPhotograph = 'https://newsroom.porsche.com/.imaging/mte/porsche-templating-theme/teaser_720x406x2/dam/pnr/2024/Products/992-II/911-Carrera-GTS/0881_nevada_coupe_u-crane_AKOS2546_edit_V02.jpg/jcr:content/0881_nevada_coupe_u-crane_AKOS2546_edit_V02.jpg';
  ...
  return (
    <div className={styles.previewSVLsContainer}>
      {previewSVLsInfo.map((dataPreviewSVL, index) => (
        <div key={`${index}`}>
          <div className={styles.previewSVLContainer}>
            ...
            {(dataPreviewSVL.mySVL == false) ? (
              dataPreviewSVL.stateNotMySVL[0] == true && dataPreviewSVL.stateNotMySVL[2] != myAddress ? (
                <div className={styles.blockedSVL}>
                  {blockedLabel}
                </div>
              ) : (
                <div>
                  {dataPreviewSVL.stateNotMySVL[3] == false ? (
                    <div className={styles.requestSVLtransfer}>
                      <RequestSVLButton requested={dataPreviewSVL.stateNotMySVL[3]} />
                    </div>
                  ) : (
