import styles from '../../../styles/components/dataSVL/fields/imagesGroupTypeField.module.css';
import { useState } from 'react';
import { PHOTOGRAPHS_SIZE } from '../../../utils/constants/constants';

type ImagesGroupTypeFieldProps = {
  placeholder: string;
...
const ImagesGroupTypeField = ({ placeholder, selectedOwner, dataSVL, selectedImages ,setDataSVL, formType, id, allowMultipleImages }: ImagesGroupTypeFieldProps) => {
...
export default ImagesGroupTypeField;
